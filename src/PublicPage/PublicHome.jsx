...
import { FaArrowRight, FaPhone, FaEnvelope, FaChevronDown, FaChevronUp } from "react-icons/fa"
  ...
  const faqData = [
    {
      ...
      answer:
        "You can book a room directly through our website using the reservation form, by emailing us at krismarkdivelodgemoalboal@gmail.com, or by calling us at 0947 520 3454. We recommend booking in advance to secure your preferred dates.",
    },
    {
      question: "What are the check-in and check-out times?",
      answer:
        "Check-in time is 2:00 PM, and check-out time is 12:00 PM. Early check-in or late check-out may be available upon request, subject to availability and additional fees.",
    },
    {
      question: "Do you have smoking and non-smoking rooms?",
      answer:
        "Yes, we offer both smoking and non-smoking rooms. Please specify your preference during booking. Smoking in non-smoking rooms will result in an additional cleaning fee.",
    },
    {
      question: "Can I change or upgrade my room after check-in?",
      answer:
        "Room changes or upgrades after check-in are subject to availability. Please contact our front desk to inquire about available options and applicable fees.",
    },
    {
      question: "What payment methods do you accept?",
      answer:
        "We accept cash (Philippine Peso) and GCash only. Payment must be made on location, as we do not accept credit cards or online transactions.",
    },
    {
      question: "What is the best season to visit your hotel?",
      answer:
        "The best time to visit Moalboal is during the dry season from November to May. The waters are clearest for diving between March and May. However, Krismark Dive Lodge is open year-round and offers a wonderful experience in any season.",
    },
    {
      question: "Does Krismark Dive Lodge allow pets?",
      answer:
        "Yes, pets are welcome at our property! We kindly ask that you keep them supervised at all times and follow our pet-friendly policies for a comfortable stay.",
    },
    {
      question: "Do you offer airport or shuttle transportation?",
      answer:
        "We do not have a dedicated airport shuttle, but we can assist in arranging private transfers upon request. Please contact us in advance for assistance.",
    },
    {
      question: "What amenities are available at the lodge?",
      answer:
        "Our lodge offers free Wi-Fi, air-conditioned rooms, a dive center, and a communal lounge area. Additional amenities include on-site gear rental and tour assistance.",
    },
  ]
      ...
      >
        ...
        <div className="relative z-10 px-4 max-w-6xl mx-auto w-full">
          <div className="mb-16 transform transition-all duration-700 translate-y-0 opacity-100">
            <h2 className="text-lg md:text-xl uppercase tracking-widest mb-2 font-light relative">
              <span className="relative z-10">Discover Paradise</span>
              <span className="absolute inset-0 blur-[8px] opacity-60 z-0">Discover Paradise</span>
            </h2>
            ...
            <p className="max-w-2xl mx-auto text-lg md:text-xl text-gray-100 relative">
              <span className="relative z-10">
                Experience world-class diving and luxurious comfort in the heart of Moalboal, Cebu
              </span>
              <span className="absolute inset-0 blur-[8px] opacity-60 z-0">
                Experience world-class diving and luxurious comfort in the heart of Moalboal, Cebu
              </span>
            </p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-10 max-w-6xl mx-auto">
            ...
            <div className="w-full lg:w-1/2">
              <div className="relative">
                <div className="rounded-xl overflow-hidden shadow-2xl border-4 border-white">
                  <img
                    src={underwaterImage || "/placeholder.svg"}
            ...
            <div className="w-full lg:w-1/2 space-y-6">
              <h2 className="text-3xl md:text-4xl font-bold text-center lg:text-left text-blue-900">
                WELCOME TO <span className="text-orange-500">KRISMARK DIVE LODGE</span> – YOUR OCEAN ADVENTURE STARTS
                HERE!
              </h2>

              <p className="text-gray-700 leading-relaxed text-lg">
                Discover Krismark Dive Lodge in Moalboal—a hidden gem by the sea where adventure and relaxation collide.
                Feel the cool ocean breeze, explore vibrant marine life, and unwind in a cozy, welcoming haven designed
                to refresh your body and soul.
              </p>

              <p className="text-gray-700 leading-relaxed text-lg">
                The sea is calling, and your unforgettable escape begins here. Whether you're seeking thrills beneath
                the waves or tranquility by the shore, our lodge offers an experience that lingers long after you leave.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <a
                  href="#rooms"
                  className="bg-orange-500 hover:bg-orange-600 text-white py-3 px-6 rounded-full font-medium transition-colors duration-200 text-center cursor-pointer"
                >
                  Explore Our Rooms
                </a>
                <a
                  href="#contact"
                  className="bg-blue-900 hover:bg-blue-800 text-white py-3 px-6 rounded-full font-medium transition-colors duration-200 text-center"
                >
                  Contact Us
                </a>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              <div>
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-blue-900 mt-2">Savor Restful Moments</h2>
                <div className="w-32 h-1 bg-orange-500 mt-3"></div>
              </div>

              <p className="text-gray-700 leading-relaxed">
                At Krismark Dive Lodge, we offer accommodations for every guest—solo travelers, couples, families, or
                groups. Choose from cozy Twin Rooms, spacious Family Rooms, versatile Triple Rooms, or elegant Standard
                Double Rooms. Each space is thoughtfully designed for comfort and convenience, providing the perfect
                base to explore. Your ideal stay starts here!
              </p>
            </div>
              ...
              {roomImages.map((image) => (
                <div
                  ...
                  onClick={() => {
                    ...
                    // Optionally filter offers based on room type
                    // You could add state here to filter offers by the clicked room type
                  }}
                >
                  <img
                  ...
                  {hoveredImage === image.id && (
                    <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center transition-opacity duration-300">
                      <span className="text-white text-sm font-medium mb-2">{image.type}</span>
                      <span className="text-xs bg-orange-500 text-white px-2 py-1 rounded-full">View Offers</span>
                    </div>
                  )}
                </div>
              ))}
            ...
            >
              <div className="flex flex-col md:flex-row">
                <div className="md:w-1/2 relative">
                  <img
                    src={offers[3].image || "/placeholder.svg"}
                    alt={offers[3].title}
      ...
      <section id="contact" className="min-h-screen flex flex-col items-center justify-center bg-red-100 py-12">
        ...
        <div className="w-full max-w-5xl bg-white p-8 rounded-lg shadow-lg mt-8">
          ...
          <p className="text-center mb-8 text-gray-600">
            No matter what your inquiry is regarding, there will always be someone to help you at Krismark Dive Lodge.
            Need to make a hotel booking? Have a question about a hotel rate? You will find all the right details below.
          </p>
          ...
          <div className="w-full max-w-4xl mx-auto">
            ...
            <div className="text-center p-6 bg-gray-50 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
              ...
              <p className="text-gray-700">
                For general inquiries, please call <span className="font-semibold">09475203454</span>
              </p>
            </div>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
              Everything you need to know about your stay at Krismark Dive Lodge to ensure a seamless and enjoyable
              experience
            </p>
          </div>
          ...
          <div className="space-y-5">
            {faqData.map((faq, index) => (
              ...
              >
                ...
                >
                  <span
                    className={`font-medium text-lg ${activeQuestion === index ? "text-blue-900" : "text-gray-800"}`}
                  >
                    {faq.question}
                  </span>
                  <div
          ...
          <div className="mt-12 text-center bg-white p-8 rounded-xl shadow-md">
            ...
            <p className="mb-6 text-gray-700">
              Our team is just a message away to assist with any additional inquiries
            </p>
            <a
              href="#contact"
              onClick={(e) => {
